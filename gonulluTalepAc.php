...
$sql = "INSERT INTO `stk_proje` (`projeID`, `stkMail`, `pozisyon`, `java`, `python`, `js`, `c`, `c_s`, `c_pp`, `ruby`, `swift`, `php`)
                        VALUES ('', '$mail', '$uzmanlik', '$dil1', '$dil2','$dil3','$dil4','$dil5','$dil6','$dil7','$dil8','$dil9')";
